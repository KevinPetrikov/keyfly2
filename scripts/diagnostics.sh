...
if [ -d "lib" ]
    ...
    echo "YOU MUST EXECUTE THIS SCRIPT FROM KEYFLY'S ROOT!"; exit 1
fi
...
echo "[ KEYFLY Info ]"
declare -r KEYFLYInfo=($(grep -oE "KEYFLY(Version|Revision)=[0-9]+" fluxion.sh))
echo "KEYFLY V${KEYFLYInfo[0]/*=/}.${KEYFLYInfo[1]/*=/}"
echo -ne "\n\n"
